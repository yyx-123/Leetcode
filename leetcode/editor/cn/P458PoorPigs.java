...
public class P458PoorPigs{
    public static void main(String[] args) {
        Solution solution = new P458PoorPigs().new Solution();
        // TO TEST
        System.out.println(solution.poorPigs(1000, 15, 55));
    ...
    class Solution {
        ...
        public int poorPigs(int buckets, int minutesToDie, int minutesToTest) {
            return (int)Math.ceil(log((minutesToTest / minutesToDie) + 1, buckets));
        }
    }
